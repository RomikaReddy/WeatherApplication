...
import drizzleimage from '../Assets/drizzleimage.webp';
...
const Weather = () => {
  ...
  return (
    <div className="container"  style={{ backgroundImage: getBackgroundImage()}} >
      ...
      <div className="temp-max">32.73</div>
      <div className="temp-min" >29.54/</div>
      ...
      <div className="data-container">
        ...
        <div className="element">
          <img src={wind} alt="tegehh" className="iconwind"></img>
          <div className="data">
